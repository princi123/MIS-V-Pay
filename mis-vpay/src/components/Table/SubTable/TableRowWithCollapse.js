...
const TableRowWithCollapse = () => {
  ...
  return (
    <tr>
      <td colSpan={9} className="tablea">
        <div className="collapse" id="collapseExample">
          <table className="table small border hidden">
            <thead>
              <tr className="">
            ...
            <tbody>
              <tr style={{ backgroundColor: '#DADADA' }}> <td>1.</td>
                <td>
              ...
              <tr style={{ backgroundColor: '#C5C5C5' }}> <td>2.</td>
                <td>
                <button className="textlink">
                  <b>431</b>
                </button></td>
              ...
              <tr style={{ backgroundColor: '#DADADA' }}> <td>3.</td>
                <td>
                <button className="textlink">
                  <b>442</b>
                </button></td>
              ...
              <tr style={{ backgroundColor: '#C5C5C5' }}> <td>4.</td>
                <td>
                <button className="textlink">
                  <b>445</b>
                </button></td>
              ...
              <tr style={{ backgroundColor: '#DADADA' }}> <td>5.</td>
                <td>
                <button className="textlink">
                  <b>446</b>
                </button></td>
