...
const TableRowWithCollapseRedemption = ({ pzone, startDate, endDate, select_type, region_name, formatNumberToIndianFormat, }) => {
            ...
            {transaction_summary_report_ufc.map((ufc, index) => (
              <React.Fragment key={index}>
                <tr>
                  ...
                  <td className="text-end">
                    {formatNumberToIndianFormat(parseFloat(ufc.RFIXED_INCOME))}
                  </td>
                  <td className="text-end">
