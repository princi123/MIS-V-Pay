...
class UfcSummaryTransactionService
  def self.get_transaction_summary_report_ufc(start_date, end_date, asset_class, select_type, employee_code,p_zone,region_name)
    ...
    procedure_name = 'sp_misvapay_get_transaction_summary_report_ufc_wise'
    
    cursor = conn.parse("BEGIN #{procedure_name}(:p_startDate, :p_endDate, :p_assetClass, :p_selectType, :p_employeeCode, :p_zone, :p_region_name, :get_all_data); END;")
